...
import com.example.learn.properties.SecurityProperties;
...
public class ValidateCodeFilter extends OncePerRequestFilter implements InitializingBean {  //接口的目的是为了在其他参数都组装完毕以后去初始化urls的值
